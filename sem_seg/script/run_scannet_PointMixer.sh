...
SCANNET_SEMSEG=/root/dataset/scannet_semseg_pointgroup
# SCANNET_SEMSEG=/root/dataset/scannet_semseg_mink
...
### Setup 
MYSHELL="run_scannet_PointMixer.sh"
DATE_TIME="2022-08-02" # `date +"%Y-%m-%d"`
NEPTUNE_PROJ="jaesung.choe/ECCV22-PointMixer-SemSeg"
COMPUTER="SCANNET-PointMixer-00"
